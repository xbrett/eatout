defmodule EatOut.ReviewsTest do
  ...
  describe "reviews" do
    ...
    @valid_attrs %{comment: "some comment", name: "some name", rating: 42, restaurant_id: "some restaurant_id"}
    @update_attrs %{comment: "some updated comment", name: "some updated name", rating: 43, restaurant_id: "some updated restaurant_id"}
    @invalid_attrs %{comment: nil, name: nil, rating: nil, restaurant_id: nil}
    ...
    test "create_review/1 with valid data creates a review" do
      ...
      assert review.restaurant_id == "some restaurant_id"
    end
    ...
    test "update_review/2 with valid data updates the review" do
      ...
      assert review.restaurant_id == "some updated restaurant_id"
    end
